...
class ZonePriceService {
  ...
  ZonePriceService()
      : baseClient = BaseClient<ZoneModel.Zone>(fromJson: (json) => ZoneModel.Zone.fromJson(json));

  Future<List<ZoneModel.Zone>> getAllZones({ required String governorateId, int page = 1}) async {
    try {
